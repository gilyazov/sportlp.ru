...
<div class="comparison__row">
    <?foreach($arResult["ITEMS"] as $arItem):?>
        ...
        <a href="<?=$arItem["DETAIL_PAGE_URL"]?>" class="comparison__product-image-wrapper" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
            <img src="<?=Sl\Core\Tools::resizeImage($arItem["PREVIEW_PICTURE"]["ID"], 300, 100, true)?>" alt="" class="comparison__product-image">
        </a>
    <?endforeach;?>
</div>
                            ...
                            <?if($arProduct = $arResult["PRODUCTS"][$arItem["ID"]]):?>
                                <label
                                    ...
                                    <span class="comparison__product-select-checkbox-content">
                                            <img src="<?=Sl\Core\Tools::resizeImage($arProduct["PREVIEW_PICTURE"], 50, 50, true)?>" alt=""
                                                 class="comparison__product-select-checkbox-image">
                                            <span
