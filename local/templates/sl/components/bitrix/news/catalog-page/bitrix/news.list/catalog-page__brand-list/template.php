                ...
                <div class="brand-block js-brand-block">
                    <div class="brand-block__info">
                        <div class="brand-block__info-bg">
                            <img src="<?=Sl\Core\Tools::resizeImage($arBrand["PROPERTY_BG_VALUE"], 1920, 550)?>" alt="" class="brand-block__info-bg-image">
                        </div>
                        ...
                        <div class="brand-block__info-category">
                            <?=count($arBrand["ITEMS"])?> <?=declNum(count($arBrand["ITEMS"]), ['модель', 'модели', 'моделей'])?>
                        </div>
                    </div>
