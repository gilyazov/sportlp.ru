...
<?foreach($arResult["ITEMS"] as $arItem):?>
    ...
    ?>
    <a href="<?=$arItem["DETAIL_PAGE_URL"]?>" class="what-to-choose comparison__what-to-choose" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
        <div class="what-to-choose__bg">
            <img data-src="<?=Sl\Core\Tools::resizeImage($arItem["PREVIEW_PICTURE"]["ID"], 1090, 370, true)?>" alt="" class="what-to-choose__bg-image lazyload">
        </div>
