...
<form name="iblock_add" action="<?=POST_FORM_ACTION_URI?>"
      class="reviews__consultation-form" data-need-validation=""
    ...
    <?if (is_array($arResult["PROPERTY_LIST"]) && !empty($arResult["PROPERTY_LIST"])):?>
        <?foreach ($arResult["PROPERTY_LIST"] as $propertyID):?>
            <div class="reviews__consultation-form-input-wrapper">
                    ...
                    switch ($INPUT_TYPE):
                        ...
                        case "N":
                            ...
                            <input type="text"
                                   ...
                                   class="text-input reviews__consultation-form-input<?if($propertyID == "NAME"):?> js-phone-input<?endif;?>"
